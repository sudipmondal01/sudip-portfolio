...
var routes = [
  {
    path: "",
    loadComponent: () => import("./chunk-WCKUI5VO.js").then((m) => m.HomeComponent)
  },
  {
    path: "archive",
    loadComponent: () => import("./chunk-E5VK73BU.js").then((m) => m.ArchiveComponent)
  },
  {
  ...
  {
    path: "films",
    loadComponent: () => import("./chunk-APPHNKL2.js").then((m) => m.FilmsPageComponent)
  },
  {
    path: "artist",
    loadComponent: () => import("./chunk-NFRLS4O7.js").then((m) => m.AboutPageComponent)
  },
  {
    path: "connect",
    loadComponent: () => import("./chunk-X22LVGS4.js").then((m) => m.ContactPageComponent)
  },
  { path: "**", redirectTo: "" }
];
