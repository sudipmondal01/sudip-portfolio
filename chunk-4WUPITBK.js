...
// src/components/contact-page.component.ts
function ContactPageComponent_Conditional_94_Template(rf, ctx) {
  if (rf & 1) {
...
function ContactPageComponent_Conditional_95_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 54);
    \u0275\u0275text(1, " Begin Our Story ");
    \u0275\u0275elementStart(2, "span", 58);
    \u0275\u0275text(3, "arrow_right_alt");
    \u0275\u0275elementEnd()();
  }
}
function ContactPageComponent_Conditional_96_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 55);
    \u0275\u0275text(1, " A beautiful start. I\u2019ll review your vision and reach out personally. ");
    \u0275\u0275elementEnd();
  }
}
function ContactPageComponent_Conditional_97_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p", 56);
    \u0275\u0275text(1, " Something went wrong. Please try again or email me directly. ");
    \u0275\u0275elementEnd();
  }
}
var ContactPageComponent = class _ContactPageComponent {
  constructor() {
    ...
    this.formSuccess = signal(false, ...ngDevMode ? [{ debugName: "formSuccess" }] : []);
    this.formError = signal(false, ...ngDevMode ? [{ debugName: "formError" }] : []);
  ...
  async onSubmit() {
    ...
    try {
      await firstValueFrom(this.http.post("https://formspree.io/f/mkovqbjq", this.contactForm.value));
      this.formSuccess.set(true);
      this.contactForm.reset({ inquiryType: "" });
      setTimeout(() => this.formSuccess.set(false), 8e3);
    } catch (error) {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ContactPageComponent, selectors: [["app-contact-page"]], decls: 98, vars: 13, consts: [[1, "pt-32", "lg:pt-48", "pb-20", "overflow-x-hidden", "min-h-screen"], [1, "max-w-[1400px]", "mx-auto", "px-6", "lg:px-10"], [1, "mb-24", "reveal", "text-center", "lg:text-left"], [1, "text-6xl", "lg:text-8xl", "font-medium", "mb-6", "tracking-tighter", "leading-tight"], [1, "font-serif-italic", "text-[#C6A96B]"], [1, "hidden", "lg:block"], [1, "text-gray-500", "text-sm", "md:text-base", "font-light", "tracking-[0.1em]", "uppercase", "italic"], [1, "h-px", "w-32", "bg-[#C6A96B]/30", "mx-auto", "lg:mx-0", "mt-10"], [1, "grid", "grid-cols-1", "lg:grid-cols-12", "gap-16", "lg:gap-24", "items-start"], [1, "lg:col-span-5", "space-y-16", "reveal", "delay-1"], [1, "text-[10px]", "tracking-[0.6em]", "uppercase", "text-[#C6A96B]", "mb-12", "font-bold", "font-mono-tech"], [1, "space-y-10"], [1, "text-gray-500", "text-[10px]", "mb-2", "uppercase", "tracking-[0.3em]", "italic"], ["href", "mailto:sudipxv@gmail.com", 1, "text-3xl", "md:text-4xl", "font-light", "hover:text-[#C6A96B]", "transition-all", "duration-500", "underline", "underline-offset-8", "decoration-white/5", "hover:decoration-[#C6A96B]/40"], [1, "text-gray-500", "text-[10px]", "mb-4", "uppercase", "tracking-[0.3em]", "italic"], [1, "flex", "flex-wrap", "gap-8", "text-[11px]", "font-bold", "uppercase", "tracking-widest"], ["href", "https://www.instagram.com/bunnyxdneo/", "target", "_blank", "rel", "noopener noreferrer", 1, "text-white", "hover:text-[#C6A96B]", "transition-colors", "border-b", "border-white/10", "pb-1"], ["href", "https://vimeo.com/sudipmondal", "target", "_blank", "rel", "noopener noreferrer", 1, "text-white", "hover:text-[#C6A96B]", "transition-colors", "border-b", "border-white/10", "pb-1"], ["href", "https://www.behance.net/sudip_mondal/", "target", "_blank", "rel", "noopener noreferrer", 1, "text-white", "hover:text-[#C6A96B]", "transition-colors", "border-b", "border-white/10", "pb-1"], ["href", "#", 1, "text-white", "hover:text-[#C6A96B]", "transition-colors", "border-b", "border-white/10", "pb-1"], [1, "p-10", "border", "border-[#C6A96B]/20", "bg-[#C6A96B]/5", "relative", "overflow-hidden", "group"], [1, "absolute", "-right-10", "-bottom-10", "opacity-5", "transition-transform", "duration-1000", "group-hover:scale-110"], [1, "material-symbols-outlined", "text-[120px]"], [1, "flex", "items-center", "gap-4", "mb-6", "relative", "z-10"], [1, "material-symbols-outlined", "text-[#C6A96B]", "text-lg"], [1, "text-[10px]", "tracking-[0.4em]", "uppercase", "font-bold", "text-[#C6A96B]", "font-mono-tech"], [1, "text-gray-400", "font-light", "leading-relaxed", "text-base", "relative", "z-10"], [1, "lg:col-span-7", "reveal", "delay-2"], [1, "bg-white/[0.02]", "p-8", "lg:p-14", "border", "border-white/5", "relative", "shadow-2xl", "shadow-black/20"], [1, "flex", "items-center", "justify-between", "mb-16"], [1, "text-[10px]", "tracking-[0.5em]", "uppercase", "text-[#C6A96B]", "font-bold", "font-mono-tech"], [1, "flex", "gap-3"], [1, "h-[2px]", "w-12", "bg-[#C6A96B]"], [1, "h-[2px]", "w-12", "bg-white/10"], [1, "space-y-12", 3, "ngSubmit", "formGroup"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "gap-10"], [1, "relative", "group"], [1, "block", "text-[9px]", "uppercase", "tracking-[0.3em]", "text-gray-500", "mb-2", "font-bold", "transition-colors", "group-focus-within:text-[#C6A96B]"], ["type", "text", "formControlName", "fullName", "name", "name", "placeholder", "e.g. Elena Rossi", 1, "w-full", "bg-transparent", "border-0", "border-b", "border-white/10", "px-0", "py-4", "text-white", "placeholder:text-gray-700", "focus:border-[#C6A96B]", "focus:ring-0", "transition-all", "outline-none", "font-light", "text-base"], ["type", "email", "formControlName", "email", "name", "email", "placeholder", "e.g. elena@vision.com", 1, "w-full", "bg-transparent", "border-0", "border-b", "border-white/10", "px-0", "py-4", "text-white", "placeholder:text-gray-700", "focus:border-[#C6A96B]", "focus:ring-0", "transition-all", "outline-none", "font-light", "text-base"], ["formControlName", "inquiryType", "name", "subject", 1, "w-full", "bg-transparent", "border-0", "border-b", "border-white/10", "px-0", "py-4", "text-white", "focus:border-[#C6A96B]", "focus:ring-0", "transition-all", "outline-none", "font-light", "appearance-none", "cursor-pointer", "text-base"], ["value", "", "disabled", ""], ["value", "destination_wedding", 1, "bg-[#040406]"], ["value", "editorial_portrait", 1, "bg-[#040406]"], ["value", "brand_campaign", 1, "bg-[#040406]"], ["value", "product_still_life", 1, "bg-[#040406]"], ["value", "travel_lifestyle", 1, "bg-[#040406]"], ["value", "personal_branding", 1, "bg-[#040406]"], ["value", "creative_collaboration", 1, "bg-[#040406]"], ["value", "custom_story", 1, "bg-[#040406]"], [1, "material-symbols-outlined", "absolute", "right-0", "bottom-4", "text-[#C6A96B]/40", "pointer-events-none"], ["formControlName", "message", "name", "message", "rows", "4", "placeholder", "In a few words, describe the feeling or the specific moment you're dreaming of...", 1, "w-full", "bg-transparent", "border-0", "border-b", "border-white/10", "px-0", "py-4", "text-white", "placeholder:text-gray-700", "focus:border-[#C6A96B]", "focus:ring-0", "transition-all", "outline-none", "font-light", "resize-none", "text-base"], [1, "pt-6"], ["type", "submit", 1, "group", "relative", "w-full", "lg:w-auto", "px-16", "py-6", "bg-[#C6A96B]", "text-black", "text-[11px]", "font-bold", "uppercase", "tracking-[0.4em]", "transition-all", "duration-700", "hover:bg-white", "active:scale-95", "disabled:opacity-30", "disabled:grayscale", "disabled:cursor-not-allowed", "shadow-xl", "shadow-[#C6A96B]/10", "hover:shadow-white/10", 3, "disabled"], [1, "flex", "items-center", "gap-3"], [1, "mt-8", "text-[10px]", "text-[#C6A96B]", "uppercase", "tracking-[0.2em]", "font-bold", "animate-fade-in-up"], [1, "mt-8", "text-[10px]", "text-red-500", "uppercase", "tracking-[0.2em]", "font-bold", "animate-fade-in-up"], [1, "w-1.5", "h-1.5", "rounded-full", "bg-black", "animate-pulse"], [1, "material-symbols-outlined", "text-sm", "group-hover:translate-x-2", "transition-transform"]], template: function ContactPageComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "article", 0)(1, "div", 1)(2, "div", 2)(3, "h1", 3);
        \u0275\u0275text(4, " Let\u2019s ");
        ...
        \u0275\u0275text(10, " Every story begins with a conversation. ");
        \u0275\u0275elementEnd();
        \u0275\u0275element(11, "div", 7);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(12, "div", 8)(13, "div", 9)(14, "section")(15, "h2", 10);
        \u0275\u0275text(16, "Direct Line");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(17, "div", 11)(18, "div")(19, "p", 12);
        \u0275\u0275text(20, "Inquiries");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(21, "a", 13);
        \u0275\u0275text(22, " sudipxv@gmail.com ");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(23, "div")(24, "p", 14);
        \u0275\u0275text(25, "Social Presence");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(26, "div", 15)(27, "a", 16);
        \u0275\u0275text(28, "Instagram");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(29, "a", 17);
        \u0275\u0275text(30, "Vimeo Narrative");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(31, "a", 18);
        \u0275\u0275text(32, "Behance Portfolio");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(33, "a", 19);
        \u0275\u0275text(34, "Vogue Portfolio");
        \u0275\u0275elementEnd()()()()();
        \u0275\u0275elementStart(35, "section", 20)(36, "div", 21)(37, "span", 22);
        \u0275\u0275text(38, "public");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(39, "div", 23)(40, "span", 24);
        \u0275\u0275text(41, "public");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(42, "h3", 25);
        \u0275\u0275text(43, "Destination Ready");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(44, "p", 26);
        \u0275\u0275text(45, " Currently accepting commissions worldwide. Specializing in high-end destination weddings, editorial fashion, and private luxury events. My passport is current and my bags are always packed for the extraordinary. ");
        \u0275\u0275elementEnd()()();
        \u0275\u0275elementStart(46, "div", 27)(47, "div", 28)(48, "div", 29)(49, "h2", 30);
        \u0275\u0275text(50, "A Quiet Invitation");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(51, "div", 31);
        \u0275\u0275element(52, "span", 32)(53, "span", 33);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(54, "form", 34);
        \u0275\u0275listener("ngSubmit", function ContactPageComponent_Template_form_ngSubmit_54_listener() {
          return ctx.onSubmit();
        });
        \u0275\u0275elementStart(55, "div", 35)(56, "div", 36)(57, "label", 37);
        \u0275\u0275text(58, "Your Name");
        \u0275\u0275elementEnd();
        \u0275\u0275element(59, "input", 38);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(60, "div", 36)(61, "label", 37);
        \u0275\u0275text(62, "Email Address");
        \u0275\u0275elementEnd();
        \u0275\u0275element(63, "input", 39);
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(64, "div", 36)(65, "label", 37);
        \u0275\u0275text(66, "What story would you like to create?");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(67, "select", 40)(68, "option", 41);
        \u0275\u0275text(69, "Select the path of our collaboration");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(70, "option", 42);
        \u0275\u0275text(71, "Destination Wedding");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(72, "option", 43);
        \u0275\u0275text(73, "Editorial Portrait");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(74, "option", 44);
        \u0275\u0275text(75, "Brand Campaign");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(76, "option", 45);
        \u0275\u0275text(77, "Product & Still Life");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(78, "option", 46);
        \u0275\u0275text(79, "Travel & Lifestyle");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(80, "option", 47);
        \u0275\u0275text(81, "Personal Branding");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(82, "option", 48);
        \u0275\u0275text(83, "Creative Collaboration");
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(84, "option", 49);
        \u0275\u0275text(85, "Custom Story Request");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(86, "span", 50);
        \u0275\u0275text(87, "expand_more");
        \u0275\u0275elementEnd()();
        \u0275\u0275elementStart(88, "div", 36)(89, "label", 37);
        \u0275\u0275text(90, "Tell me a little about the moment you want to capture.");
        \u0275\u0275elementEnd();
        \u0275\u0275element(91, "textarea", 51);
        \u0275\u0275elementEnd();
        \u0275\u0275elementStart(92, "div", 52)(93, "button", 53);
        \u0275\u0275conditionalCreate(94, ContactPageComponent_Conditional_94_Template, 3, 0, "span", 54)(95, ContactPageComponent_Conditional_95_Template, 4, 0, "span", 54);
        \u0275\u0275elementEnd();
        \u0275\u0275conditionalCreate(96, ContactPageComponent_Conditional_96_Template, 2, 0, "p", 55);
        \u0275\u0275conditionalCreate(97, ContactPageComponent_Conditional_97_Template, 2, 0, "p", 56);
        \u0275\u0275elementEnd()()()()()()();
      }
      if (rf & 2) {
        let tmp_1_0;
        ...
        \u0275\u0275advance(5);
        \u0275\u0275classProp("border-red-500", ((tmp_1_0 = ctx.contactForm.get("fullName")) == null ? null : tmp_1_0.invalid) && ((tmp_1_0 = ctx.contactForm.get("fullName")) == null ? null : tmp_1_0.touched));
        \u0275\u0275advance(4);
        \u0275\u0275classProp("border-red-500", ((tmp_2_0 = ctx.contactForm.get("email")) == null ? null : tmp_2_0.invalid) && ((tmp_2_0 = ctx.contactForm.get("email")) == null ? null : tmp_2_0.touched));
        \u0275\u0275advance(4);
        \u0275\u0275classProp("border-red-500", ((tmp_3_0 = ctx.contactForm.get("inquiryType")) == null ? null : tmp_3_0.invalid) && ((tmp_3_0 = ctx.contactForm.get("inquiryType")) == null ? null : tmp_3_0.touched));
        \u0275\u0275advance(24);
        \u0275\u0275classProp("border-red-500", ((tmp_4_0 = ctx.contactForm.get("message")) == null ? null : tmp_4_0.invalid) && ((tmp_4_0 = ctx.contactForm.get("message")) == null ? null : tmp_4_0.touched));
        \u0275\u0275advance(2);
        \u0275\u0275property("disabled", ctx.isSubmitting());
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.isSubmitting() ? 94 : 95);
        \u0275\u0275advance(2);
        \u0275\u0275conditional(ctx.formSuccess() ? 96 : -1);
        \u0275\u0275advance();
        \u0275\u0275conditional(ctx.formError() ? 97 : -1);
      }
    }, dependencies: [ReactiveFormsModule, \u0275NgNoValidate, NgSelectOption, \u0275NgSelectMultipleOption, DefaultValueAccessor, SelectControlValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName], styles: ["\n\n@keyframes _ngcontent-%COMP%_fadeInUp {\n  from {\n    opacity: 0;\n    transform: translateY(10px);\n  }\n  to {\n    opacity: 1;\n    transform: translateY(0);\n  }\n}\n.animate-fade-in-up[_ngcontent-%COMP%] {\n  animation: _ngcontent-%COMP%_fadeInUp 1s cubic-bezier(0.16, 1, 0.3, 1) forwards;\n}\ninput[_ngcontent-%COMP%]:focus, \nselect[_ngcontent-%COMP%]:focus, \ntextarea[_ngcontent-%COMP%]:focus {\n  border-bottom-width: 1.5px;\n  box-shadow: 0 4px 10px -4px rgba(198, 169, 107, 0.2);\n}\n/*# sourceMappingURL=contact-page.component.css.map */"], changeDetection: 0 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ContactPageComponent, [{
    type: Component,
    args: [{ selector: "app-contact-page", imports: [ReactiveFormsModule], template: `
  ...
  `, changeDetection: ChangeDetectionStrategy.OnPush, styles: ["/* angular:styles/component:css;9234bf456ec8ad6b81c9d8999f359eed54bd81d15a1378f9ffc970aa203530e9;C:/Users/Fytrips/Downloads/Portfolio Website/src/components/contact-page.component.ts */\n@keyframes fadeInUp {\n  from {\n    opacity: 0;\n    transform: translateY(10px);\n  }\n  to {\n    opacity: 1;\n    transform: translateY(0);\n  }\n}\n.animate-fade-in-up {\n  animation: fadeInUp 1s cubic-bezier(0.16, 1, 0.3, 1) forwards;\n}\ninput:focus,\nselect:focus,\ntextarea:focus {\n  border-bottom-width: 1.5px;\n  box-shadow: 0 4px 10px -4px rgba(198, 169, 107, 0.2);\n}\n/*# sourceMappingURL=contact-page.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ContactPageComponent, { className: "ContactPageComponent", filePath: "src/components/contact-page.component.ts", lineNumber: 193 });
})();
export {
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-4WUPITBK.js.map
